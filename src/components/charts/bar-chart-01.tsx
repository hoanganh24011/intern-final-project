...
import { chartColors } from "@/src/components/charts/chartjs-config";
import "@/src/components/charts/chartjs-config";
import {
	Chart,
	BarController,
	BarElement,
...
// Import utilities
import { tailwindConfig, formatValue } from "@/src/components/utils/utils";
			...
			plugins: [
				{
					...
					afterUpdate(c, args, options) {
						...
						items?.forEach((item) => {
							...
							// @ts-ignore
							const theValue: number = c.data.datasets[item.datasetIndex!].data.reduce((a, b) => {
								if (a && b) {
